...
import { Terminal, Plus, Minimize2, Code, Package } from "lucide-react"
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-48">
                ...
                <DropdownMenuItem onClick={() => {
                    // TODO: Open language command panel
                    console.log('Language Commands panel will be opened')
                }}>
                    <Code className="w-4 h-4 mr-2" />
                    <span>Dil Komutları</span>
                </DropdownMenuItem>

                <DropdownMenuItem onClick={() => {
                    // TODO: Open package manager panel
                    console.log('Package Manager panel will be opened')
                }}>
                    <Package className="w-4 h-4 mr-2" />
                    <span>Paket Yöneticisi</span>
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
    )
